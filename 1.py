        ...
        for line in f:
            ...
            if line.isnumeric():
                ...
                for i in range(ingredients_count):
                    ...
                    ingredient = reed_ingredient_line(ingredient_line)
                    cookbook[dish_name].append(ingredient)
            else:
                dish_name = line
    return cookbook

def shop_list_dishes(dishes, person_count):
...
shop_list = shop_list_dishes(['Запеченный картофель', 'Омлет'], 2)
